...
const Photos = () => {
  ...
  //   photoParallaxMobile.style.backgroundPositionY =
  //     offsetPhotoMobile * 0.7 + "px";
  // });
  ...
  const submitImages = async() => {
    ...
    let res;
    try {
        res = await Axios.post('http://localhost:5000/api/photos/add', {images: [...imageArray]})
        // res = await sendRequest('http://localhost:5000/api/photos/add', 'post', {images: []})
        console.log(res)
    } catch(err) {
        alert(err)
        //use a modal for errors
    }
  }
  ...
  return (
    <div className="parallax-wrapper">
      ...
      <div className="about-text_wrapper">
        <div className="about-text">
          ...
          <p>
            ...
            ornare. Et netus et malesuada fames. Tellus pellentesque eu
      ...
      <p className="edit-title">Add More Photos</p>
